...
import BookDetails from "../BookDetails/BoookDetails"
        ...
        <Context.Consumer>
            {value => {
                ...
                const onBookAdd = () =>{                    
                    ...
                    console.log(p)
                    const x = addBook(p)
                    this.setState({bookName:'',bookDescription:'',book_total_pages:''})
                    return x
                }
                ...
                return(
                    ...
                    {onAdd ? (
                        <form onSubmit={this.onSubmitSuccess}>
                            ...
                            <button type="submit" onClick={onBookAdd}>Add</button>
                        </form>
                    ):('')}
                    </div>
                )
